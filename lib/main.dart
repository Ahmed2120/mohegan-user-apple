...
import 'package:flutter_grocery/helper/const.dart';
// import 'package:flutter_facebook_auth/flutter_facebook_auth.dart';
...
Future<void> main() async {
  ...
  // orderd = sharedPreferences?.getString('orderd');
  // log(orderd.toString());
  ...
  if (!kIsWeb) {
    ...
    await Firebase.initializeApp(
      ...
      apiKey: "AIzaSyAaRvmwmMKlQfwpzlsjnV9p56lt07UU_Ys",
      // authDomain: "grofresh-3986f.firebaseapp.com",
      projectId: "mohejin-9c563",
      storageBucket: "mohejin-9c563.appspot.com",
      messagingSenderId: "179539261311",
      appId: "1:179539261311:android:647ed25658141ef3138c4a",
