    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          CustomDirectionality(
            ...
            PriceConverter.convertPrice(
                context, widget.orderList![widget.index].orderAmount),
        ...
        Row(children: [
          ...
          Text(
            '${getTranslated('order_is', context)} ${getTranslated(widget.orderList![widget.index].orderStatus, context)}',
            style:
                        ...
                        onPressed: () async {
                          if (orderProvider.isActiveOrder) {
                            ...
                            List<OrderDetailsModel> orderDetails =
                                (await orderProvider.getOrderDetails(widget
