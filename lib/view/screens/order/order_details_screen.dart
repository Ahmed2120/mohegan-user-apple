...
class OrderDetailsScreen extends StatefulWidget {
  ...
  final int? orderId;
  final bool? notfication;

  const OrderDetailsScreen(
      {Key? key, this.orderModel, this.orderId, this.notfication})
      : super(key: key);
    ...
    return Scaffold(
      ...
      body: Consumer<OrderProvider>(
        builder: (context, order, child) {
          ...
          // if (widget.notfication == true) {
          //   Navigator.pushNamed(context,
          //       RouteHelper.getChatRoute(orderModel: order.trackModel));
          // }
