  ...
  static Future<void> initialize(
    ...
    flutterLocalNotificationsPlugin.initialize(
      ...
      onDidReceiveNotificationResponse:
        ...
        if (notificationResponse.payload!.isNotEmpty) {
          ...
          title = jsonDecode(notificationResponse.payload!)['title'];
        }
        try {
          if (orderId != null && title == 'المحفظة') {
            Get.navigator!.push(
              MaterialPageRoute(
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      if (kDebugMode) {
        ...
        // orderd = int.tryParse(message.data['order_id']);
        // print(orderd);
      }
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      ...
      // print("snkannknaknnnanan  aaja   anan${orderd}");
      // if (orderd == 1) {
      //   Get.navigator!.push(
      //     MaterialPageRoute(
      //         builder: (context) => const WalletScreen(
      ...
      // if (orderId.toString() != message.notification!.titleLocKey) {
      // Get.navigator!.push(
      //   MaterialPageRoute(
      //       builder: (context) => const WalletScreen(
      //             fromWallet: true,
      ...
      //   );
      // }
      // if (message.notification!.titleLocKey == orderId.toString()) {
      //   Get.navigator!.push(
      //     MaterialPageRoute(
      //         builder: (context) => OrderDetailsScreen(
      //               orderId: orderId,
...
Future<dynamic> myBackgroundMessageHandler(RemoteMessage message) async {
  if (kDebugMode) {
    ...
    orderId = message.notification!.titleLocKey != null
    ...
    // if (message.notification!.titleLocKey == 'المحفظة') {
    // Get.navigator?.push(
    //   MaterialPageRoute(
    //       builder: (context) => const WalletScreen(
    //             fromWallet: true,
